...
public class Document {
  ...
  /**
   * The {@code io.opaa.knowledge.LibraryFolder} this document sits in (ADR-0020), or {@code null}
   * for the library's root - the same convention {@code LibraryFolder#getParentFolderId()} uses one
   * level up.
   */
   ...
   * by the Nachlauf through {@code ChunkContextPrefix#titleAtRest}, so it reproduces the ingest's
