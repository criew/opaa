 ...
 * German because it is user-facing - it is meant to end up in an indexing job's status (#467), not
 * only in a log (see AGENTS.md's German/English split for user-visible text vs. developer text).
 */
