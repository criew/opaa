 ...
 */
public class DocxDocumentFormat extends FileDocumentFormat<DocxDocumentFormat.DocxContent> {
  ...
  @Override
  protected DocxContent read(DocumentFormatSource source) throws IOException {
  ...
  @Override
  protected DocumentFormatResult chunks(DocumentFormatSource source, DocxContent content) {
