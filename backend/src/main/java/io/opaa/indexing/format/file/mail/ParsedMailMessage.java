 ...
 * before {@link MailDocumentFormat} turns it into chunks (docs/features/ingestion-pipelines.md,
 * Teil 3, Punkt 5).
 *
 ...
 *     #attachments()} carries separately for {@link MailDocumentFormat} to route recursively
