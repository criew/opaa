...
public class PptxDocumentFormat extends FileDocumentFormat<PptxDocumentFormat.PptxContent> {
  ...
  @Override
  protected PptxContent read(DocumentFormatSource source) throws IOException {
  ...
  @Override
  protected DocumentFormatResult chunks(DocumentFormatSource source, PptxContent content) {
  ...
  /** One line per row via {@link TableText}, mirroring {@link DocxDocumentFormat}. */
