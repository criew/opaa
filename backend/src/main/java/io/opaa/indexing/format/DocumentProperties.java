...
/**
 * The raw, uninterpreted sources a {@link DocumentFormat} can hand to the core metadata extraction
 ...
 *     DocumentFormatSource#detectedExtension()}, never by a pipeline; {@code null} when routing
 *     resolved none
