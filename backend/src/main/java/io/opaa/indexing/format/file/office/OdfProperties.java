...
/**
 * DoS-hardening limits {@link OdtDocumentFormat}/{@link OdpDocumentFormat} apply against a
 * pathological ODT/ODP file - the same style of operator-tunable ceiling {@link
 * io.opaa.indexing.format.file.tabular.TabularProperties} carries for the ODS reader.
 *
