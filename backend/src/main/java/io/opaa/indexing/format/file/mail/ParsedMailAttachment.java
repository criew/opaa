 ...
 * temporary file - the caller ({@link MailDocumentFormat}) is responsible for deleting {@link
 * #tempFile()} once it has routed the attachment through {@code DocumentFormatRegistry}.
 *
