 ...
 * the link is the only handle the future indexing run has on the detail page an entry points to.
 * {@code title} and {@code description} are {@code null}, not blank, when the feed omits the
