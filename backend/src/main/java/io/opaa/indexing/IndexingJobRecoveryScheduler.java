 ...
 *       silently discarded by a full queue before this issue's {@code AbortPolicy} change. This
 *       assumes exactly one backend process (ADR-0021, "OPAA ist bis auf Weiteres Single-Instance")
 *       - see {@link IndexingJobService#recoverJobsOrphanedByRestart} for what would need to change
 *       under genuine multi-instance operation.
