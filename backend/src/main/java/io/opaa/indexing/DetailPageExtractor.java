...
class DetailPageExtractor {
  ...
  record DetailPage(String mainText, List<AttachmentCandidate> attachments) {}
   ...
   */
  DetailPage fetch(HttpClient httpClient, String entryUrl, String authHeader)
   ...
   */
  static final class RejectedByRemoteException extends RuntimeException {
   ...
   */
  static final class UnsupportedContentTypeException extends RuntimeException {
