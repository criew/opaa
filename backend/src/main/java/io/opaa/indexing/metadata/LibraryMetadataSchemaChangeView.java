 ...
 *
 * @param id the running change itself - what lets a caller ask whether <b>its own</b> operation is
 *     done rather than whether the library has any open change left
