...
public class FullTextChunkStore {
   ...
   * whenever the lexemes this class stores change</b>: rows at another version are counted as the
   * version backlog by {@link io.opaa.indexing.maintenance.FullTextIndexFillStateService} and
   * brought up to date only by {@link
   * io.opaa.indexing.maintenance.PipelineReindexService#reindexBatch}, never by a background job.
