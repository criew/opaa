 ...
 *     transient transport failure before it gives up. Default 5; {@code 0} falls back to it.
...
public record S3Properties(
   ...
   * downloads. To be measured against MinIO (#1380).
   */
  ...
  public static S3Properties defaults() {
    return new S3Properties(0, 0, null, 0, null, DEFAULT_REQUEST_BUDGET_PER_RUN);
  }
}
