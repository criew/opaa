 ...
 * listing, full sync, run executor and event intake - and the connector settings ({@link
 * io.opaa.indexing.source.s3.S3SourceSettings}) the library stores as its {@code source_settings}.
 *
