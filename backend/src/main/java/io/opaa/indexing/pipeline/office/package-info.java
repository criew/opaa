 ...
 * the package's other public types are the pipeline beans themselves. ODT/ODP additionally read
 * {@code styles.xml} for header/footer and master-slide text, DOCX every header/footer part through
 * POI - all three contribute that text as one deduplicated leading chunk via {@link
