 ...
 * parser ({@link io.opaa.indexing.pipeline.office.OdfPackage}) rather than Apache POI, which never
 * reads OpenDocument. {@link io.opaa.indexing.pipeline.office.OdfPackage} is the only type here
 * made public purely for reuse - by {@code io.opaa.indexing.pipeline.tabular}'s ODS reader ; the
 * package's other public types are the pipeline beans themselves. ODT/ODP additionally read {@code
