 ...
 * anbindungsweg Spring AI wires here - {@code spring.ai.model.chat}/{@code embedding} are fixed to
 * {@code openai}, not a choice anymore. {@code application.yml} therefore does carry a default base
 * URL (the local Ollama endpoint), unlike before #762: the default itself already stays inside the
