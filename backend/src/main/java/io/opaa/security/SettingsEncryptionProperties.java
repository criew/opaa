...
/**
 * Configuration for {@link SettingsEncryptor} and {@link SettingsEncryptionKeyGuard} (#756): the
 * master key used to encrypt secrets carried by managed system settings, starting with {@code
 * llm_models.api_key_ciphertext}.
 *
