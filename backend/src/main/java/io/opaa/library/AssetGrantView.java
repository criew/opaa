 ...
 * @param grantedByDisplayName {@code null} when the grant carries no {@code grantedByUserId} (a
 *     historical row from before that field existed) or that user no longer exists.
 */
