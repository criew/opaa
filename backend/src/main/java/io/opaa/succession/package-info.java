 ...
 * {@code io.opaa.asset} (an asset's owner), {@code io.opaa.space} (a space's capable ADMIN) and
 ...
 * io.opaa.permission.SuccessionFindingSource} for its own object type; the asset source answers for
 * every asset type at once.
 *
