 ...
 * and, when given, {@link #getCode()} as the stable, machine-readable {@code code} of the response
 * (e.g. {@code TOKEN_INVALID}) - for the cases a client has to act on rather than display.
 */
