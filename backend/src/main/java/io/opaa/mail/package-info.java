 ...
 * at runtime, a transport rebuilt without a restart, German templates a deployment may override and
 * always reset, and a send that reports its outcome instead of raising.
 *
