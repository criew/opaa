...
public final class MetadataFilterExpressions {
   ...
   */
  public static Filter.Expression subordinateTo(
  ...
  public static boolean keptWithoutValue(MetadataFilter filter, Document chunk) {
  ...
  public static int countKeptWithoutValue(MetadataFilter filter, List<Document> candidates) {
    if (filter.isEmpty()) {
      return 0;
    }
    int count = 0;
