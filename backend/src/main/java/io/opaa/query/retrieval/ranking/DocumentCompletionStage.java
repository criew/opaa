...
import io.opaa.query.retrieval.ranking.DocumentCompletion.CompletionEvent;
 ...
 */
@Component
public class DocumentCompletionStage implements RetrievalStage {
  ...
  public StageOutcome apply(RetrievalContext context, RetrievalState state) {
    ...
    return new StageOutcome(
        state.withCandidateLists(
            List.of(new CandidateList(RetrievalListLabel.FUSED_LIST_LABEL, completed))),
