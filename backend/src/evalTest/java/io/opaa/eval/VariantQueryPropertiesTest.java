...
class VariantQueryPropertiesTest {
  ...
  private static final QueryProperties PRODUCTION =
      new QueryProperties(8, 25, 1.0, 0.3, 0.5, false, 3, 2);
  ...
  void anOverriddenFieldReplacesOnlyThatField() {
    var overrides = new PipelineVariant.QueryOverrides(null, 0.7, null, null, null, null);
  ...
  void permissionHistorySampleRateIsNeverOverridden() {
    var overrides = new PipelineVariant.QueryOverrides(null, null, null, null, null, null);
