...
public record EvaluationReport(
    ...
    // docs/features/retrieval-benchmark.md §5 "Zustandsfelder": declared
    // (expected_state.raw_vector)
    // vs. measured case state. Null if no case declares a state — absent, not "audited and clean".
