 ...
 *
 * <p>This domain's pipeline baseline was drawn together with its raw-vector one, so this test is
 * wired into {@code checkVerwaltungRetrievalBaseline} from the start.
 */
