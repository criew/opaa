 ...
 * roughly 10 s per call on CPU, more than the nightly job's budget carries. Switching this on is a
 * deliberate, manually invoked measurement whose fixed points differ from the committed baseline's,
 * so {@code PipelineBaselineComparator} reports it as an incomparable baseline rather than as a
 * regression.
 */
