...
class QueryIntegrationTest {
   ...
   * first - is exercised end to end. A hypothetical implementation that dropped the permission
   * filter on any sub-query but the first would leak {@code b*.md} sources into the fused result;
   * this test would then fail on the {@code allSatisfy} assertion below.
   */
  @Test
