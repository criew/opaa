...
- **Frischer Worktree:** `pnpm install` in `frontend/` einmal vor Frontend-Arbeit ausführen; pnpm speist `node_modules` per Hardlinks aus dem benutzerweiten Store, ein frischer Worktree ist damit in Sekunden installiert.
