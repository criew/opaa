...
**@Space** (die dem Space assoziierten Bibliotheken als eigener Spezial-Chip) ist mit #203/#686 im Datenmodell und über die API abbildbar (`SpaceAssetAssociation`, `GET/POST /spaces/{spaceId}/libraries`) — der Chip selbst in der Eingabeleiste ist noch nicht gebaut und bleibt einem Folge-Issue vorbehalten.
