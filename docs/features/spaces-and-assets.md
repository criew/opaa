...
**@Space** (die dem Space assoziierten Bibliotheken als eigener Spezial-Chip) kommt erst mit #203 — im Datenmodell und Frontend offengehalten, noch nicht gebaut.
...
| Chatart | Suchbereich |
|---|---|
| Chat ohne Agent, Leiste zeigt **@Alles-Wissen** | **Zielbild:** die dem Space assoziierten Bibliotheken **geschnitten mit** den lesbaren Bibliotheken des Nutzers. **Übergangsregel bis #203:** Ohne Space↔Bibliothek-Assoziation gilt ersatzweise **alle Bibliotheken, die der Nutzer lesen darf** |
