...
> **Hinweis für zukünftige Arbeiten:** Da die Instanz hinter Keycloak liegt und keinen anonymen Zugang bietet, kann ein dort ausgerollter Demo-Korpus nicht ohne Weiteres öffentlich vorgezeigt werden — jeder Betrachter benötigt einen Keycloak-Account. Ein anonymer Lese- oder Gastzugang existiert derzeit nicht.
