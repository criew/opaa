...
| `OPAA_OIDC_AUTHORITY` | — (leer) | `http://localhost:8180/realms/opaa` | Bootstrap-Wert; muss der Issuer-URI entsprechen (eine Abweichung wird protokolliert und verworfen) |
