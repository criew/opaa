...
| `OPAA_INDEXING_S3_MAX_RETRIES` | `5` | `5` | Wie oft ein Aufruf nach `503 SlowDown`/`429` oder einem vorübergehenden Transportfehler mit exponentiellem Backoff wiederholt wird, bevor er als ratenbegrenzt scheitert — gezählt je Lauf, nie stillschweigend |
