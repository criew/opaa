...
| `OPAA_INDEXING_S3_DOWNLOAD_CONCURRENCY` | `2` | `2` | Gleichzeitige Objekt-Downloads je Lauf, während die Auflistung weiterläuft — eine Obergrenze für die Last auf dem Objektspeicher, kein Durchsatzziel; `1` lädt seriell. Die Dokumentstrecke selbst verarbeitet weiterhin ein Objekt nach dem anderen in Auflistungsreihenfolge, damit das Laufprotokoll nachvollziehbar bleibt |
