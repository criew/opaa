...
| `OPAA_QUERY_MAX_CHUNKS_PER_DOCUMENT` | `2` | `2` | Nach der Fusions-/MMR-Auswahl bevorzugt bis zu diese viele Chunks je bereits ausgewähltem Dokument aus der ohnehin berechtigungs- und schwellenwertgefilterten Kandidatenmenge (#932) — verdrängt wird dabei stets nur der schwächste Chunk eines Dokuments, das schon mit mindestens zwei Chunks vertreten ist, nie eines mit nur einem. `1` schaltet die Dokument-Vervollständigung vollständig ab (Stand vor #932) |
| **Indizierung** | | | |
