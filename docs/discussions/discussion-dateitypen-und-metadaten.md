...
4. **Rechte-Invariante.** Vorklassifikation und Schema-Vorschlag laufen nur über Dokumente, die der anlegende Nutzer lesen darf; aggregierte Metadaten (z. B. Wertelisten für Filter-UI) dürfen nichts über unlesbare Dokumente verraten ([Durchsetzung zur Abfragezeit](../features/spaces-and-assets.md#durchsetzung-zur-abfragezeit) sinngemäß auf Metadaten erweitert).
