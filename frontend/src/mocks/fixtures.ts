...
export const mockSpaces: SpaceListResponse[] = [
  ...
  },
  {
    ...
    visibility: 'PRIVATE',
    memberCount: 5,
    memberships: { groupCount: 2, userCount: 3 },
    libraryCount: 2,
    chatCount: 7,
    userRole: 'ADMIN',
    createdAt: '2026-03-01T10:00:00Z',
...
export const mockSpaceMembers: Record<string, SpaceMemberResponse[]> = {
  ...
  'space-engineering': [
    ...
    // #1820: eine geschützte Gruppe erscheint namenlos und ohne jede Zahl - die Zeile bleibt,
    // damit ein ADMIN die Mitgliedschaft beenden kann, die er nicht sieht.
    {
      id: 'membership-engineering-personalrat',
      subjectType: 'GROUP',
...
export const mockGroups: GroupListResponse[] = [
  ...
  },
  {
    id: 'group-referat-49',
    name: 'Referat 49',
    description: 'Vom Anbieter nicht mehr gemeldet',
    kind: 'ORG_UNIT',
    ...
    sourcePath: '/Haus A/Abteilung 4/Referat 49',
    parentGroupId: null,
    memberCount: 3,
    dissolved: true,
    releasedForUse: true,
...
/**
 * Was die Subjekt-Auswahl anbietet (#1820, ADR-0036 Entscheidung 9). Bewusst breiter als
 * mockGroups: zwei gleichnamige Gruppen aus zwei Anbietern, eine davon extern, dazu eine kleine
 * interne Gruppe, eine nicht mehr wirksame und die geschützte — die nur auf ihre vollständige
 * Bezeichnung antwortet (siehe den Handler).
 */
export const mockSelectableGroups: SelectableGroupResponse[] = [
  {
    id: 'group-referat-50',
    name: 'Referat 50',
    origin: 'PROVIDER',
  ...
  {
    id: 'group-referat-52-aufgeloest',
    name: 'Referat 52',
    origin: 'PROVIDER',
    provider: {
      id: 'oidc-provider-beschaeftigte',
    ...
    sourcePath: '/Haus/Abteilung 5/Referat 52',
    activeMemberCount: 6,
    smallGroup: false,
    emptyGroup: false,
    protectedGroup: false,
...
/** The mock's stored groups always carry their list; only the answer withholds it (#1989). */
