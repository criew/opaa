...
const NOTE_RULES: NoteRule[] = [
  ...
  },
  {
    ...
    pattern: /^decomposition found nothing to search for: retrieval halted$/,
    german: () =>
      'Zerlegung: Die Nachricht enthält nichts, wonach zu suchen ist; die Suche wurde nicht ausgeführt.',
  },
  {
