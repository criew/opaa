...
class SpecEnumParityTest {
  ...
  static Stream<Arguments> mappedEnums() {
    return Stream.of(
        ...
        Arguments.of("AssetGrantSubjectType", AssetGrantSubjectType.values()),
        Arguments.of("PermissionTransferScope", PermissionTransferScope.values()),
        Arguments.of("SuccessionKind", SuccessionKind.values()),
        Arguments.of("SuccessionObjectType", SuccessionObjectType.values()),
        Arguments.of("SuccessionAddressee", SuccessionAddressee.values()),
