 ...
 * as a cron expression (LibraryScheduleCodec) so a future expert cron field would only be a UI
 * change, but the API itself only ever accepts one of these four shapes.
 */
