...
/**
 * Lifecycle of an {@code AuditIncidentScopeGrant} (backend module). Mirrored by the database check
 * constraint {@code chk_audit_incident_scope_grants_status}; keep both in sync.
 *
